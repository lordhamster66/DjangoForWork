...
CREATE TABLE 05b_2list_recover like wd.05b_2list_recover;
insert into 05b_2list_recover select * from wd.05b_2list_recover WHERE time_h <= DATE_FORMAT(DATE_SUB(curdate(),INTERVAL 1 DAY),"%Y-%m-%d 23:30:00");
